...
public class UpcomingActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Movie>> {

    @BindView(R.id.language_button)
    ImageView languageButton;
    @BindView(R.id.recyclerUpp)
    RecyclerView recyclerUpp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerUpp.setHasFixedSize(true);
        recyclerUpp.setAdapter(adapterNowUp);

        recyclerUpp.setLayoutManager(new GridLayoutManager(this, 2));
        adapterNowUp = new AdapterNowUp(this);
        adapterNowUp.notifyDataSetChanged();
        recyclerUpp.setAdapter(adapterNowUp);
        getSupportLoaderManager().initLoader(0, bundle, UpcomingActivity.this);
    }
...
//                Intent iBack = new Intent(UpcomingActivity.this, MainActivity.class);
//                startActivity(iBack);
//                break;
                finish();
                break;
            case R.id.language_button:
                PopupMenu popup = new PopupMenu(UpcomingActivity.this, languageButton);
